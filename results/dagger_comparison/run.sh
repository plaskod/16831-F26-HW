...
for robot in "${robots[@]}"; do
  ../.venv/bin/python -u rob831/scripts/run_hw1.py \
    --expert_policy_file "rob831/policies/experts/${robot}.pkl" \
    --expert_data "rob831/expert_data/expert_data_${robot}-v2.pkl" \
    --env_name "${robot}-v2" --exp_name "figure2_dagger_${robot}_L3_H64_U1000_seed1" \
    ...
    > "../results/dagger_comparison/${robot}.log" 2>&1
done
